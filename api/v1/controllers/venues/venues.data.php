...
class VenueData {
    ...
    public static function getVenue($id) {
        ...
        $qFields = DBConn::preparedQuery("SELECT e.id, e.identifier, e.desc "
                ...
                . "JOIN as_auth_lookup_venue_field AS look ON e.id = look.auth_field_id "
        ...
        $qGroups = DBConn::preparedQuery("SELECT g.id, g.group, g.desc "
                ...
                . "JOIN as_auth_lookup_group_venue AS look ON g.id = look.auth_group_id "
    ...
    public static function insertVenue($validVenue) {
        return DBConn::insert("INSERT INTO as_auth_venues(venue, slug, desc, created_user_id, last_updated_by) "
