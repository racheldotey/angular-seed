...
angular.module('app.admin.dashboard', [])
    .controller('AdminDashboardCtrl', ['$scope', '$filter', '$compile', 'DataTableHelper', 'DTOptionsBuilder', 'DTColumnBuilder', 
    function($scope, $filter, $compile, DataTableHelper, DTOptionsBuilder, DTColumnBuilder) {
