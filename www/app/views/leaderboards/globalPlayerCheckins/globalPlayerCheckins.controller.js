...
angular.module('app.leaderboards.globalPlayerCheckins', ['ui.grid', 'ui.grid.autoResize'])
    .controller('GlobalPlayerCheckinsLeaderboardCtrl', ['$window', '$state', '$stateParams', '$rootScope', '$scope', 'uiGridConstants', 'ApiRoutesLeaderboards',
        function($window, $state, $stateParams, $rootScope, $scope, uiGridConstants, ApiRoutesLeaderboards) {
            ...
            ($scope.refreshGrid = function(limit) {
                ApiRoutesLeaderboards.getGlobalPlayerCheckinsLeaderboard(limit).then(function(result) {
