 ...
 * Layout Header: Host
 * 
 * Used to control the host layout header and top navigtion.
 */

angular.module('app.host.header', [])
        .controller('HostHeaderCtrl', ['$scope', 'UserSession', 'AuthService', 'siteSystemVariables', 
